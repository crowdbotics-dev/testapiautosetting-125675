...
## Project Structure
    ...
    ├── testapiautosetting_125675  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125675`
...
2. Clone this repo and `cd testapiautosetting_125675`
